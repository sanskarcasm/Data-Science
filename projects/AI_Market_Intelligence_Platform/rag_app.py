...
# Optional: Custom CSS to further reduce padding and stretch content
st.set_page_config(
...
# Use a single wide container for all main content
with st.container():
    # Responsive columns: input (1/3), output (2/3)
    ...
    with col2:
        ...
        if get_answer and user_query:
            with st.spinner("Thinking..."):
                # --- RAG Pipeline (replace with your actual pipeline code) ---
                ...
                llm = OllamaLLM(model="llama3")  # Or use a smaller model if needed
